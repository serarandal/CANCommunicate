...
if __name__ == "__main__":
    ...
    PopupWindow9 = QtWidgets.QWidget()
    PopupWindow10 = QtWidgets.QWidget()
    ...
    ui16.setupUi(MainWindow8,Dialog)
    ui17.setupUi(Dialog,PopupWindow9,PopupWindow10)
    ui18.setupUi(PopupWindow9)
    ui19.setupUi(PopupWindow10)
